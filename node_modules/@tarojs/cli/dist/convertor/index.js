                    ...
                    if (lastImport) {
                        ...
                        if (imports && imports.length) {
                            imports.forEach(({ name, ast, wxs }) => {
                                ...
                                lastImport.insertAfter(template_1.default(`import ${importName} from '${helper_1.promoteRelativePath(path.relative(outputFilePath, importPath))}'`, babylon_1.default)());
                            });
                        }
                        if (depComponents && depComponents.size) {
                            depComponents.forEach(componentObj => {
                                ...
                                lastImport.insertAfter(template_1.default(`import ${name} from '${helper_1.promoteRelativePath(path.relative(sourceFilePath, component))}'`, babylon_1.default)());
                            });
                        }
                    }
                }
